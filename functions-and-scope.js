// Je gaat functies schrijven die we kunnen hergebruiken om een lijst met eindcijfers van
// studenten te checken. Je zult over de cijfers heen moeten itereren (hoe pak je dat aan?),
...
// Log het antwoord in de terminal.
// ik moet de sum van alles hebben
// dan de gemiddeld van de sum hebben
// ik doe dit door:
// loop om door alle nummers te gaan
// dan sla ik alles in een let (sum)
// dan de average berekenen door (sum/numbers.length) en opslaan in een const (average)
// en vragen om de average te returnen
...
console.log(averageCalculator(grades))
...
// Zorg ervoor dat het gemiddelde cijfer dat wordt teruggegeven uit de functie netjes wordt
...
// Je mag hier geen bestaande methoden voor gebruiken. Schrijf de stapjes eerst uit en vraag jezelf de
// volgende dingen af:
...
// we maken een loop om door alle nummers te gaan
// we maken een variable met de hoogste cijfer
// we vergelijken de andere nummers met het

function findTheHighestGrade (grades){
    let highestGrade = 0;
    for (let i = 0; i < grades.length; i++){
        // hier voeg ik een logika waar als we de hogste cijfer vinden , dan wordet het de let
...
findTheHighestGrade([1, 2, 3, 4, 5, 6, 7]);
/* 3b: Omschrijven tot een herbruikbare functie */
// Schrijf een functie genaamd highestGrade, die een array van cijfers verwacht (zoals grades) en het
// hoogste cijfer teruggeeft. Gebruik hiervoor jouw antwoord van 3a.
